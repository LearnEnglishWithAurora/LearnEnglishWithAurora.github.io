import"./index-BMGIH1KI.js";function r(e,n){return e.replaceAll(n,"").replaceAll("&nbsp;"," ")}async function g(e){let n=`https://en.wiktionary.org/api/rest_v1/page/definition/${e}`,i=new RegExp(`< *\\/? *[a-z]+ *( [a-z]+="[^<>"]+" *)* *\\/? *>|<[^>]*>|
